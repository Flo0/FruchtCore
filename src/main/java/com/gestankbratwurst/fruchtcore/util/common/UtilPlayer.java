...
import com.gestankbratwurst.fruchtcore.tasks.TeleportParticleThread;
import com.gestankbratwurst.fruchtcore.util.common.sub.WaitingPlayer;
import com.gestankbratwurst.fruchtcore.util.events.PlayerReceiveEntityEvent;
import com.gestankbratwurst.fruchtcore.util.events.PlayerUnloadsEntityEvent;
...
public class UtilPlayer implements Listener, Runnable {
  ...
  public static void init(final FruchtCore host) {
